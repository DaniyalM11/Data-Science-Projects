...
''' Based on the model change the all_conversations indexing. i.e. for first 10000 conversations use
 'all_conversations[:10000]' '''
...
##############Fit vs Load Model Section - Start ############################

'''Important - when wanting to fit a new model, uncomment out the fit/save section and comment out the model 
load_weights section. When wanting to load an already run model do the opposite. For this project, this is
where the number of Epochs would be set.'''
...
#Decode Answer from Trained Model
